...
import { LucideLoader2, LucidePlus, LucideRocket, LucideTrash2, LucideX } from "lucide-react";
                    ...
                    <div className="rounded-lg shadow-md p-6">
                        ...
                        {loading && !spaces.length ? (
                            <div className="flex justify-center items-center py-12">
                                <LucideLoader2 className="animate-spin text-blue-500" size={32} />
                            </div>
                        ) : (
                            <div className="space-y-4">
                                {spaces.length === 0 ? (
                                    <p className=" text-center py-8">No public spaces available</p>
                                ) : (
                                    spaces.map((space) => (
                                        <div
                                            key={space.id}
                                            className={`border rounded-lg p-4 hover:border-blue-300 cursor-pointer transition-colors ${selectedSpace?.id === space.id ? 'border-blue-500' : 'border-gray-200'
                                                } ${loading ? 'opacity-50' : ''
                                                }`}
                                            onClick={() => fetchSpaceById(space.id)}
                                        >
                                            <h3 className="font-bold text-lg">{space.name}</h3>
                                            <p className=" text-sm mb-3 line-clamp-2">{space.description || 'No description'}</p>
                    ...
                    {showCreateForm ? (
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => setNewSpace({ ...newSpace, width: parseInt(e.target.value) || 0 })}
                                                className="w-full p-2 border  rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                                min="1"
                                                max="100"
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => setNewSpace({ ...newSpace, height: parseInt(e.target.value) || 0 })}
                                                className="w-full p-2 border  rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                                min="1"
                                                max="100"
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => setNewSpace({ ...newSpace, depth: parseInt(e.target.value) || 0 })}
                                                className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                                min="1"
                                                max="100"
                                            />
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => setNewSpace({ ...newSpace, gravity: parseFloat(e.target.value) || 0 })}
                                                className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                                step="0.1"
                                            />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                onChange={(e) => setNewSpace({ ...newSpace, lightingTheme: e.target.value })}
                                                className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                            >
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setNewSpace({ ...newSpace, backgroundImage: e.target.value })}
                                            className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                        />
                                    </div>
                        ...
                        <div className=" rounded-lg shadow-md p-6">
                            ...
                            <div className="mb-6">
                                ...
                                <p className="">{selectedSpace.description || "No description provided."}</p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        <div className=" px-3 py-2 rounded-md flex items-center">
                                            <span className="font-medium mr-2">W:</span> {selectedSpace.width}
                                        </div>
                                        <div className=" px-3 py-2 rounded-md flex items-center">
                                            <span className="font-medium mr-2">H:</span> {selectedSpace.height}
                                        </div>
                                        <div className="  px-3 py-2 rounded-md flex items-center">
                                            <span className="font-medium mr-2">D:</span> {selectedSpace.depth}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="px-3 py-2 rounded-md inline-flex items-center">
                                        <span className="font-medium mr-2">Gravity:</span> {selectedSpace.gravity}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex justify-between items-center mt-8">
                                <div>
                                    <span className={`px-3 py-1 rounded-full text-xs ${selectedSpace.isPublic
