      ...
      <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
        {pendingFriends.map((request) => (
          ...
          >
            <div className="flex items-center gap-3">
              <Avatar>
                <AvatarImage src={request?.user?.avatars?.imageUrl} />
                <AvatarFallback>
      ...
      <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
        {blockedUsers.map((user) => (
          ...
          >
            <div className="flex items-center gap-3">
              <Avatar>
                <AvatarImage src={user?.avatars?.imageUrl} />
                <AvatarFallback>
            ...
            <CardContent>
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">@{session?.user?.displayName}</p>
                </div>
              </div>
